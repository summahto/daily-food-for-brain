package com.summahto.multipledatasources.configuration;
...
@EnableJpaRepositories(basePackages = "com.summahto.multipledatasources.repository.member",
...
public class MemberDataSourceConfiguration {
    ...
    public PlatformTransactionManager memberTransactionManager(
            final @Qualifier ("memberEntityManagerFactory") LocalContainerEntityManagerFactoryBean memberEntityMangerFactory) {
        return new JpaTransactionManager(memberEntityMangerFactory.getObject());
    }
