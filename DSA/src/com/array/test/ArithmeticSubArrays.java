...
public class ArithmeticSubArrays {
    ...
    private static Boolean check(int[] sub) {
        Arrays.sort(sub);
    ...
    //Taking the advantage of the fact that diff=  max-min/ n-1 and all the elements starting from min to max should be present in the array
